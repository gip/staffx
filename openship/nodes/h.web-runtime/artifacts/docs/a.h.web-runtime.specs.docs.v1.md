---
id: a.h.web-runtime.specs.docs.v1
...
This docs artifact provides a detailed specification checkpoint for Web Runtime (Host) under concern General Specs. Use it together with matrix-linked documents to rebuild equivalent behavior without source-level assumptions.
