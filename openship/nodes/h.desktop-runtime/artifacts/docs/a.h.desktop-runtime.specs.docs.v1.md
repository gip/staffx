---
id: a.h.desktop-runtime.specs.docs.v1
...
This docs artifact provides a detailed specification checkpoint for Desktop Runtime (Host) under concern General Specs. Use it together with matrix-linked documents to rebuild equivalent behavior without source-level assumptions.

Technical scope:
- Node ID: h.desktop-runtime.
- Parent: s.root.
