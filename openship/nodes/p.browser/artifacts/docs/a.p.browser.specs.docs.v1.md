...
This docs artifact provides a detailed specification checkpoint for Browser Execution Process (Process) under concern General Specs. Use it together with matrix-linked documents to rebuild equivalent behavior without source-level assumptions.

Technical scope:
- Node ID: p.browser.
- Parent: h.browser-user-agent.
- Inbound edges: 0. Outbound edges: 1. Dependency edges: 0.
