---
id: a.l.agent-runtime.features.summary.v1
nodeId: l.agent-runtime
concern: Features
type: Summary
language: en
---

This summary captures the current operational role of @staffx/agent-runtime Execution Library (Library) for concern Features. It is intended for rebuild teams to quickly understand what must be preserved before validating detailed specifications.

Current scope: @staffx/agent-runtime Execution Library participates in 0 outbound and 2 inbound graph connections. The node runs with ownership=first_party and boundary=internal. These constraints define who can modify this node and which trust boundaries are crossed by its traffic.
