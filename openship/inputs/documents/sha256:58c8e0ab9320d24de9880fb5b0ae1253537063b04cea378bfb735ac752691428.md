...
title: Features - Notion Platform
language: en
---

This feature specification describes the active runtime responsibilities for Notion Platform. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.
...
- Child nodes: Notion API Process.
