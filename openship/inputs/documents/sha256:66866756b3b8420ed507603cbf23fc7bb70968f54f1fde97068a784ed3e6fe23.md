...
title: Features - Google Platform
language: en
---

This feature specification describes the active runtime responsibilities for Google Platform. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.
...
- Child nodes: Google Docs API Process, Google OAuth Process.
