...
title: Features - Desktop Runtime
language: en
---

This feature specification describes the active runtime responsibilities for Desktop Runtime. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.
...
- Child nodes: Desktop Main Process, Desktop Renderer Process.
