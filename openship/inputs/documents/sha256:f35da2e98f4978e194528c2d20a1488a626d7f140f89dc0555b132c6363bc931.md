...
title: Specs - Browser User Agent
language: en
---

This technical specification defines rebuild-critical implementation constraints for Browser User Agent. The intent is to allow a new team to recreate equivalent runtime behavior from documents alone.
...
- Metadata platform: user-browser.
