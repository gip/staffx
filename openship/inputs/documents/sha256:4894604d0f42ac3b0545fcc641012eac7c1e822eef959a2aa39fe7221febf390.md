...
title: Features - API Runtime
language: en
---

This feature specification describes the active runtime responsibilities for API Runtime. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.
...
- Child nodes: API Service Process.
