...
title: Features - Active Runtime System
language: en
---

This feature specification describes the active runtime responsibilities for StaffX Active Runtime. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.

Primary responsibilities:
- Owns Root scope within the runtime graph and participates in concern matrix execution boundaries.
...
- Parent node: none.
- Child nodes: API Runtime, Auth0, Browser User Agent, Data Runtime, Desktop Runtime, Google Platform, Notion Platform, Web Runtime.
