...
title: Specs - API Runtime
language: en
---

This technical specification defines rebuild-critical implementation constraints for API Runtime. The intent is to allow a new team to recreate equivalent runtime behavior from documents alone.
...
- Metadata platform: node-fastify.
