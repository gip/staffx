...
This feature specification describes the active runtime responsibilities for Auth0 Identity Process. It is written as an as-built artifact and should be treated as the source of truth for rebuild decisions at node scope.
...
- Parent node: Auth0.
- Child nodes: none.
- Outbound edges: 1. Inbound edges: 3.
